...
export const SECTIONS = [
  {
    ...
    flag: (a) => (a.pinned ? "Pinned" : null),
    blank: () => ({ id: "", date: "", tag: "Update", title: "", body: "", pinned: false }),
    fields: [
...

  {
    ...
    flag: (e) => (e.when === "upcoming" ? "Upcoming" : null),
    blank: () => ({
      when: "upcoming",
      date: "TBD",
      time: "TBD",
...

  {
    ...
    flag: (p) => (p.parts?.length ? `${p.parts.length} parts` : null),
    blank: () => ({
      slug: "",
      n: "",
      title: "",
